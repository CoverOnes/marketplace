...
// gateway timestamp and signature computed over them. headerKYCTier carries the
// honest fixRealTier the signature is computed over; tamper tests override
// headers after construction.
